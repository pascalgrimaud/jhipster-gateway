...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhgateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhgateway API";

        private String description = "jhgateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhgateway";
